!(function (n) {
  ...
  function (n, e, r) {
    ...
    function a() {
      ...
      try {
        for (
          var t, o = h.deal.pile.cards[Symbol.iterator]();
          !(n = (t = o.next()).done);
          n = !0
        ) {
          var a = t.value,
      ...
      for (var r = 0; r < 4; r++)
        for (var t = 1; t <= 13; t++) {
          ...
          i.classList.add(
            ...
            h.cards.push({ el: i, type: h.types[r], number: t, facingUp: !1 });
        }
      for (var c = 0; c < 4; c++) {
        var d = document.createElement("div");
        d.classList.add("aces", "aces--" + c),
          h.finish.push({ el: d, cards: [] }),
          f.appendChild(d);
      }
      for (var l = 0; l < 7; l++) {
        var u = document.createElement("div");
        u.classList.add("seven", "seven--" + l),
          h.desk.push({ el: u, cards: [] }),
          x.appendChild(u);
      }
      (p.onclick = a),
        (g.onclick = o),
    ...
    var l = document.getElementById("js-solitaire"),
      ...
      w = function (n) {
        for (var e = 0; e < 7; e++) {
          ...
          if (r > -1) return { location: "desk", pile: e, index: r };
        }
        for (var t = 0; t < 4; t++) {
          var o = h.finish[t].cards.indexOf(n);
          if (o > -1) return { location: "finish", pile: t, index: o };
        }
        for (var a = ["deal", "pile"], i = 0; i < a.length; i++) {
          var c = a[i],
            d = h.deal[c].cards.indexOf(n);
          if (d > -1) return { location: "deal", pile: c, index: d };
        }
      },
      Z = function (n) {
        var e = w(n),
        ...
        return function (e) {
          ...
          if (!h.moving.capture)
            if ((L(), o)) {
              ...
              if ("deal" === k && "pile" === y)
                for (
                  var Z = h.deal.pile.cards.length - 1,
                    E = Math.max(-1, Z - 3),
                    q = Z;
                  q > E;
                  q--
      ...
      T = function (n, e) {
        ...
        try {
          for (
            var a, i = h.moving.destinations[Symbol.iterator]();
            !(r = (a = i.next()).done);
            r = !0
          ) {
            var c = a.value,
              ...
              u = d.top;
            if (
              (c.el.classList.remove("finish-dest"),
              n > p && n < p + s && e > u && e < u + l)
            ) {
              var f = c.target,
                x = f.dest,
      ...
      I = function (n) {
        ...
        if (1 === o)
          for (var i = 0; i < 4; i++) {
            ...
            if (
              0 === d.length &&
              (a.push({ el: s, target: { dest: "finish", pile: i, card: n } }),
              e)
            )
              return a;
          }
            ...
            if (p + 1 === o) {
              ...
              if (f === t) {
                if (
                  (a.push({
                    el: h.finish[l].el,
                    target: { dest: "finish", pile: l, card: n },
                  }),
                  e)
                )
                  return a;
        ...
        for (var x = 0; x < 7; x++) {
          ...
          if (null !== v) {
            if (
              ...
              (a.push({
                el: h.cards[v].el,
                target: { dest: "desk", pile: x, card: n },
              }),
              e)
            )
              return a;
          ...
          f = function (n, e, r, t, o) {
            ...
            u(e, r, c, d),
              (this.update = function () {
                ...
                return (
                  r > i.height - 96 && ((r = i.height - 96), (o = 0.85 * -o)),
                  (o += 0.98),
  ...
  function (n, e, r) {
    ...
    function o(n, e) {
      for (var r = [], t = {}, o = 0; o < n.length; o++) {
        var a = n[o],
          ...
          d = a[2],
          s = a[3],
          l = { css: c, media: d, sourceMap: s };
        t[i] ? t[i].parts.push(l) : r.push((t[i] = { id: i, parts: [l] }));
      }
      return r;
    }
    function a(n, e) {
    ...
    function u(n, e) {
      var r = e.css,
        t = e.media;
      if ((t && n.setAttribute("media", t), n.styleSheet))
      ...
      (e.convertToAbsoluteUrls || a) && (t = A(t)),
        o &&
          (t +=
            ...
            " */");
      var i = new Blob([t], { type: "text/css" }),
        c = n.href;
